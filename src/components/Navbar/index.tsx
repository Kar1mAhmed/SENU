...
const Navbar = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-40 pt-[46px] px-4 md:px-0">
        <div className="bg-glass-fill backdrop-blur-md border border-white/10 rounded-full max-w-[1240px] h-[71px] mx-auto pl-4 pr-4 md:pl-[64px] md:pr-[24px] py-[16px] flex items-center">
