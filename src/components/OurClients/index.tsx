...
const OurClients: React.FC = () => {
    const extendedLogos = [...clientLogos, ...clientLogos]; // Duplicate for seamless scroll

    return (
        <section className="py-16 md:py-20">
            <div className="max-w-7xl mx-auto  md:px-6 lg:px-8">
                <h2 className="text-4xl font-light ml-2 text-white sm:text-5xl md:text-6xl">
                    Our <br /> <span className="text-yellow-400">BIG</span> Clients
                </h2>
                <div className="mt-8 relative w-full max-w-[1278px] h-[90px] md:h-[142px] mx-auto bg-glass-fill-clients backdrop-blur-md md:rounded-2xl overflow-hidden">
                    <div className="absolute inset-0 flex items-center">
                        <div className="w-full flex animate-scroll">
