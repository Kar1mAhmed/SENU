    ...
    return (
        <div className="w-full bg-transparent flex flex-col mb-8 ">
            ...
            <div className="relative w-full aspect-[560/620] max-w-full md:max-w-[450px] lg:max-w-[480px] xl:max-w-[560px]">
                ...
                } w-[7%] aspect-[1/4] bg-opacity-90 ${colors.bg} rounded-full flex flex-col items-center justify-center gap-[8%]`}>
                    {icons.map((icon, iconIndex) => (
                        <Icon 
                            key={iconIndex} 
                            src={icon} 
                            colorClass={colors.iconColor} 
                            className="w-[50%] h-[50%] max-w-[16px] max-h-[16px]" 
                        />
                    ))}
                </div>
