...
export const mockProjects: Project[] = [
    {
        ...
        thumbnailUrl: '/images/covers/2.jpg',
        category: 'Branding',
        type: 'image',
    },
    {
        ...
        thumbnailUrl: '/images/covers/1.jpg',
        category: 'Branding',
        type: 'image',
    },
    {
        ...
        thumbnailUrl: '/images/covers/4.jpg',
    ...
    },
    {
        ...
        thumbnailUrl: '/images/covers/3.jpg',
        category: 'Logo design',
        type: 'image',
    },
    {
        ...
        thumbnailUrl: '/images/service-branding.jpg',
        category: 'UI/UX',
        type: 'image',
    },
    {
    ...
    {
        id: '9',
        name: 'Brand Motion Graphics',
        client: 'Motion Studios',
        work: ['Motion Graphics', 'Branding'],
        imageUrl: '/images/covers/9.jpg',
        thumbnailUrl: '/images/covers/9.jpg',
        videoUrl: '/videos/motion-1.mp4',
        category: 'Motions',
        type: 'horizontal',
        description: 'Dynamic motion graphics showcasing brand evolution and transformation through animated storytelling.',
    },
    {
        id: '10',
        name: 'Product Launch Video',
        client: 'Tech Innovators',
        work: ['Motion Graphics', 'Video Production'],
        imageUrl: '/images/covers/10.jpg',
        thumbnailUrl: '/images/covers/10.jpg',
        videoUrl: '/videos/motion-2.mp4',
        category: 'Motions',
        type: 'horizontal',
        description: 'Engaging promotional video with smooth transitions and compelling visual effects.',
    },
    {
        id: '11',
        name: 'Social Media Reel',
        client: 'Trendy Brand',
        work: ['Social Media', 'Video Editing'],
        imageUrl: '/images/covers/11.jpg',
        thumbnailUrl: '/images/covers/11.jpg',
        videoUrl: '/videos/reel-1.mp4',
        category: 'Shorts',
        type: 'vertical',
        description: 'Trendy social media reel optimized for mobile viewing and maximum engagement.',
    },
    {
        id: '12',
        name: 'TikTok Campaign',
        client: 'Youth Brand',
        work: ['Social Media', 'Content Creation'],
        imageUrl: '/images/covers/12.jpg',
        thumbnailUrl: '/images/covers/12.jpg',
        videoUrl: '/videos/reel-2.mp4',
        category: 'Shorts',
        type: 'vertical',
        description: 'Creative short-form content designed for Instagram and TikTok platforms.',
    },
];
